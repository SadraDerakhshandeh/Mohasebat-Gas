...
,
  ...
  {id:'commercial_single_new', title:'تصرف تجاری(تفکیک شده، مستقل تک واحدی) – ساختمان جدید', desc:'تصرف تجاری تفکیک شده و مستقل تک واحدی در ساختمان جدید.', vals:['مجاز','مجاز','مجاز','ممنوع','ممنوع','ممنوع'], req:'نصب تجهیزات ایمنی درصورت تشخیص نیاز با نظر طراح'},
