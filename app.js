...
,
  ...
  {id:'commercial_single_new', title:'تصرف تجاری(تفکیک شد، مستقل تک واحدی) – ساختمان جدید', desc:'تصرف تجاری تفکیک شده و مستقل تک واحدی در ساختمان جدید.', vals:['مجاز','مجاز','مجاز','ممنوع','ممنوع','ممنوع'], req:'نصب تجهیزات ایمنی درصورت تشخیص نیاز با نظر طراح'},
  {id:'commercial_single_small', title:'تصرف تجاری(تفکیک شد، مستقل تک واحدی) – ساختمان جدید و موجود با زیربنای حداکثر 60 مترمربع', desc:'تصرف تجاری تفکیک شده و مستقل تک واحدی با زیربنای حداکثر 60 مترمربع.', vals:['مجاز','مجاز','مجاز','مجاز','مجاز','مجاز'], req:'نصب تجهیزات ایمنی درصورت تشخیص نیاز با نظر طراح'},
];
